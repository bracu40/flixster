...
Deployed Application (optional): [Flixster Deployed Site](https://flixster-tfxz.onrender.com/)
...
- [x] **Display Movies**
  ...
  - [ ]xFor each movie displayed, users can see the movie's:
    - [x] Title
    - [x] Poster image
    - [x] Vote average
...
**Walkthrough video:** [Flixster Walkthrough](https://www.loom.com/share/c51482f7cca24d80b4600544719ae562)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

Yes, it helped build this project since I have never looked at React.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have implemented a proper lists page for the watched and favorites, adding AI-powered movie recommendations and the ability to write reviews on movies watched. I would also implement
more personal styling.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I created a proper presentation slidedeck, but I didn't use up all of the time that I was allowed.
...
Shout out to Charles, David, Enes, and the people in my practice presentation room.